...
See `.env.example` for and example of the required format.
...
About half of the code has been "vibe-coded", feel free to help clean-up where you can. Thus, AI contributions are also welcome, but at least do some low effort testing before submitting a PR. Thanks!
